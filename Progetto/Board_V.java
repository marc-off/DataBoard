...
public class Board_V<E extends Data> {
    /**
    ...
    private Vector<Vector<E>> Datastream = new Vector<Vector<E>>();
    //  JAVADOC: Constructs an empty list of lists with an initial capacity of ten*ten
    private Vector<Vector<String>> Friendlist = new Vector<Vector<String>>();
    //  JAVADOC: Constructs an empty list of lists with an initial capacity of ten*ten
    private Vector<E> datasorted = new Vector<E>();
    //  JAVADOC: Constructs an empty list of lists with an initial capacity of ten
    private Vector<E> datafriend = new Vector<E>();
    //  JAVADOC: Constructs an empty list of lists with an initial capacity of ten
    public Board_V(String owner, String passw) {
    ...
    */
    public void createCategory (String category, String passw) throws NullPointerException, AlreadyExistingCategoryException, WrongPasswordException {
        ...
        Datastream.add(new Vector<E>());
        Friendlist.add(new Vector<String>());
    ...
    */
    ...
    //  JAVADOC: Returns the element (a Vector of elements of <E>) at the specified position (the index of the first occurrence of the specified element (category) in this list (Categories), or -1 if this list does not contain the element) in this list (Datastream), and removes all the elements from this list.
    Friendlist.get(Categories.indexOf(category)).clear();
    //  Returns the element (a Vector of elements of String) at the specified position (the index of the first occurrence of the specified element (category) in this list (Categories), or -1 if this list does not contain the element) in this list (Friendlist), and removes all the elements from this list.
        }
    }
    /**
    * @modifies: this (se i controlli di identità sono RISPETTATI!)
    ...
    */
    ...
    //  JAVADOC: Returns the element (a Vector of elements of <E>) at the specified position (the index of the first occurrence of the specified element (category) in this list (Categories), or -1 if this list does not contain the element) in this list (Datastream), and appends the specified element ('dato') to the end of this list.
    return true;
    ...
    */
    ...
    while ( (i < Datastream.size()) && (!search) ) {
        ...
        //  SIGNIFICATO DELL'ESPRESSIONE LOGICA: Returns the element (a Vector of elements of <E>) at the specified position ('i') in this list (Datastream), or -1 if this list does not contain the element) in this list (Datastream), and returns true if this list contains the specified element ('dato').
        else i++;
    }
    if (!search) throw new DatoNotFoundException();
    
    return Datastream.get(i).get(Datastream.get(i).indexOf(dato));
    //  JAVADOC: Returns the element at the specified position ('i') in this list --> Vector<E>. Then, again, returns the element at the specified position (the index of the first (and only) occurrence of the element 'dato') in this list.
    ...
    */
    ...
    while ( i < Datastream.size() ) {
        if (Datastream.get(i).contains(dato)) {
            search = true;
            //  SIGNIFICATO DELL'ESPRESSIONE LOGICA (da JAVADOC): Returns the element (a Vector of elements of <E>) at the specified position ('i') in this list ('Datastream'), or -1 if this list does not contain the element) in this list ('Datastream'), and returns true if this list contains the specified element ('dato').
            Datastream.get(i).remove(dato);
            //  JAVADOC: Returns the element (a Vector<E>) at the specified position ('i') in this list. Then, removes the first (and, according to OUR implementation, the only one) occurrence of the specified element ('dato') from this list, if it is present.
        }
        else i++;
    }
    if (!search) throw new DatoNotFoundException();
    ...
    while ( (i < Datastream.size()) && (!isfriend) ) {
        ...
        //  SIGNIFICATO DELL'ESPRESSIONE LOGICA (da JAVADOC): Returns the element (a Vector of elements of <E>) at the specified position ('i') in this list (Datastream), or -1 if this list does not contain the element) in this list (Datastream), and returns true if this list contains the specified element (dato).
            ...
            if ( Friendlist.get(i).contains(friend) ) {
                ...
                //  JAVADOC: Returns the element (of Vector<E>) at the specified position in this list ('i', which is the first occurrence of a Vector<E> which contains the element 'dato' of <E>). Then, again, returns the element at the specified position (the first and only occurrence of element 'dato' of <E>, in this Vector<E> in Datastream, which contains this exact element 'dato') in this list. Finally, checks if the Vector<String> of friends who liked this element 'dato' contains the element of String 'friend'.
    ...
    */
    ...
    //  JAVADOC: Returns the element (of Vector<E>) at the specified position in this list ('categoryindex'). Then, again, returns a view of the portion of this list between the specified fromIndex (0), inclusive, and toIndex (size() of Vector<E> of Datastream element at 'categoryindex' position) , exclusive.
